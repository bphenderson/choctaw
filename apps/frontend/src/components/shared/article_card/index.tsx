...
import {
  CmsContentLink,
  type CmsContentLinkProps,
} from "@remkoj/optimizely-cms-nextjs/components";
...
export const ArticleCard: FunctionComponent<ArticleCardProps> = ({
  ...
  const authorList: Array<string> = (
    Array.isArray(article.authors) ? article.authors : [article.authors]
  ...
  return (
    <div key={article.key} className="article-list-item w-full h-full relative">
      {/* @ts-expect-error */}
      <Link href={article.link}>
        ...
        >
          ...
          <div className="flex justify-between mb-[16px]">
            ...
            <p className="!text-[12px] text-pale-sky my-0">
              <DateDisplay value={article.published} />
            </p>
          </div>
