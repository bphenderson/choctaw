...
import { CompositionNodeDataFragmentDoc, type ExperienceDataFragment, type Locales, type InputMaybe } from "@/gql/graphql";
...
export const BlankExperienceExperience : CmsComponent<BlankExperienceDataFragment> = ({ data, ctx }) => {
    const composition = getFragmentData(CompositionNodeDataFragmentDoc, (data as ExperienceDataFragment).composition)
