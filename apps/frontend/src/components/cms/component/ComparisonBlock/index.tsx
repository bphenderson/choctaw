...
export const ComparisonBlockComponent: CmsComponent<ComparisonBlockDataFragment> = ({ data, contentLink, ctx }) => {
  return (
    <section className="vb:section vb:section:DefaultGrid relative container mx-auto px-8 flex flex-col py-4 md:py-8 lg:py-12">
      {data.comparisonTitle && (
        <CmsEditable cmsFieldName="ComparisonTitle" as="h2" className="text-3xl font-bold" ctx={ctx}>
          {data.comparisonTitle}
        </CmsEditable>
      )}
