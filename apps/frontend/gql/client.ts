...
`;
export const ContactUsFormBlockDataFragmentDoc = gql`
...
export const getArticleListElementItemsDocument = gql`
  query getArticleListElementItems(
    ...
    BlogPostPage(
      ...
      locale: $locale
      where: {
        _metadata: { status: { eq: "Published" }, key: { notIn: $excludeKeys } }
        Topic: { in: $topics }
      }
    ) {
      items {
...
export const getDefaultArticleListDocument = gql`
  query getDefaultArticleList($locale: [Locales!]) {
    ArticleListElement(
      where: {
        _metadata: {
          displayName: { startsWith: "[DEFAULT]" }
          status: { eq: "Published" }
        }
      }
      locale: $locale
...
export const getBlogSectionExperienceMetaDataDocument = gql`
  query getBlogSectionExperienceMetaData(
    $key: String!
    $version: String
    $locale: [Locales!]
  ) {
...
export const getFundSectionExperienceMetaDataDocument = gql`
  query getFundSectionExperienceMetaData(
    $key: String!
    $version: String
    $locale: [Locales!]
  ) {
...
export const getLocationSectionExperienceMetaDataDocument = gql`
  query getLocationSectionExperienceMetaData(
    $key: String!
    $version: String
    $locale: [Locales!]
  ) {
...
export const getLocationSearchPageMetaDataDocument = gql`
  query getLocationSearchPageMetaData(
    $key: String!
    $version: String
    $locale: [Locales]
  ) {
    ...
    appLayout: LayoutSettingsBlock(
      where: {
        _or: [
          ...
          {
            _and: [
              { appIdentifiers: { exist: true } }
              { appIdentifiers: { eq: $domain } }
            ]
          }
        ]
      }
...
export const personalizedSearchContentDocument = gql`
  query personalizedSearchContent(
    $term: String!
    $topInterest: String
    $locale: [String!]
    $withinLocale: [Locales]
    ...
    Content: _Page(
      where: {
        _or: [
          { _fulltext: { match: $term } }
          { _fulltext: { match: $topInterest, boost: $boost } }
        ]
        _metadata: { url: { base: { exist: true } } }
      }
      orderBy: { _ranking: SEMANTIC }
...
export function getSdk(
  ...
  return {
    ...
    getDefaultArticleList(
      variables?: Schema.getDefaultArticleListQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getDefaultArticleListQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getDefaultArticleListQuery>(
            getDefaultArticleListDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getDefaultArticleList",
    ...
    getChildBlogPosts(
      variables: Schema.getChildBlogPostsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getChildBlogPostsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getChildBlogPostsQuery>(
            getChildBlogPostsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getChildBlogPosts",
    ...
    getBlogSectionExperienceMetaData(
      variables: Schema.getBlogSectionExperienceMetaDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getBlogSectionExperienceMetaDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getBlogSectionExperienceMetaDataQuery>(
            getBlogSectionExperienceMetaDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getBlogSectionExperienceMetaData",
    ...
    getChildFundPosts(
      variables: Schema.getChildFundPostsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getChildFundPostsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getChildFundPostsQuery>(
            getChildFundPostsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getChildFundPosts",
    ...
    getFundSectionExperienceMetaData(
      variables: Schema.getFundSectionExperienceMetaDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getFundSectionExperienceMetaDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getFundSectionExperienceMetaDataQuery>(
            getFundSectionExperienceMetaDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getFundSectionExperienceMetaData",
    ...
    getChildLocationPosts(
      variables: Schema.getChildLocationPostsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getChildLocationPostsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getChildLocationPostsQuery>(
            getChildLocationPostsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getChildLocationPosts",
    ...
    getLocationSectionExperienceMetaData(
      variables: Schema.getLocationSectionExperienceMetaDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getLocationSectionExperienceMetaDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getLocationSectionExperienceMetaDataQuery>(
            getLocationSectionExperienceMetaDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getLocationSectionExperienceMetaData",
    ...
    getBlogPostPageMetaData(
      variables: Schema.getBlogPostPageMetaDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getBlogPostPageMetaDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getBlogPostPageMetaDataQuery>(
            getBlogPostPageMetaDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getBlogPostPageMetaData",
    ...
    getFundPostPageMetaData(
      variables: Schema.getFundPostPageMetaDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getFundPostPageMetaDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getFundPostPageMetaDataQuery>(
            getFundPostPageMetaDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getFundPostPageMetaData",
    ...
    getLandingPageMetaData(
      variables: Schema.getLandingPageMetaDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getLandingPageMetaDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getLandingPageMetaDataQuery>(
            getLandingPageMetaDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getLandingPageMetaData",
    ...
    getLocationPageMetaData(
      variables: Schema.getLocationPageMetaDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getLocationPageMetaDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getLocationPageMetaDataQuery>(
            getLocationPageMetaDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getLocationPageMetaData",
    ...
    getLocationSearchPageMetaData(
      variables: Schema.getLocationSearchPageMetaDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getLocationSearchPageMetaDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getLocationSearchPageMetaDataQuery>(
            getLocationSearchPageMetaDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getLocationSearchPageMetaData",
    ...
    getFooterData(
      variables?: Schema.getFooterDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getFooterDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getFooterDataQuery>(
    ...
    getHeaderData(
      variables?: Schema.getHeaderDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getHeaderDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getHeaderDataQuery>(
    ...
    getLocales(
      variables?: Schema.getLocalesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getLocalesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getLocalesQuery>(
            getLocalesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
    ...
    getArticles(
      variables?: Schema.getArticlesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.getArticlesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.getArticlesQuery>(
            getArticlesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
    ...
    searchContent(
      variables: Schema.searchContentQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.searchContentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.searchContentQuery>(
    ...
    personalizedSearchContent(
      variables: Schema.personalizedSearchContentQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Schema.personalizedSearchContentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Schema.personalizedSearchContentQuery>(
            personalizedSearchContentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "personalizedSearchContent",
