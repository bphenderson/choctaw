...
import LocationPostsSection from "./partials/locationposts";
import { getLocationPosts } from "./actions/getLocationPosts";
...
LocationSectionExperienceExperience.displayName =
  "Blog/News Section (Experience/BlogSectionExperience)";
LocationSectionExperienceExperience.getDataFragment = () => [
  "LocationSectionExperienceData",
  LocationSectionExperienceDataFragmentDoc,
];
LocationSectionExperienceExperience.getMetaData = async (
  contentLink,
  locale,
  client,
) => {
  const sdk = getSdk(client);
  const data = await sdk.getLocationSectionExperienceMetaData({
    key: contentLink.key,
  ...
  return {
    ...
    other: {
      "idio:content-type": "Location Section (Experience)",
    },
  };
};
...
export default LocationSectionExperienceExperience;
